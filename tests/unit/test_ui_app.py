...
def test_uigraph_uses_persistent_checkpointer(tmp_path) -> None:
    ...
    class _Probe:
        """Minimal stand-in: records checkpointer + exposes thread_id."""
    ...
    # Also: the default (no arg) builds from settings.checkpoint_backend
    # and is non-None — i.e. not the old implicit MemorySaver default.
